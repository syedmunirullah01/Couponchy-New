                  ...
                  <TableCell>{offer.storeName}</TableCell>
                   <TableCell>
                    <div className="flex flex-col gap-0.5">
                      <span className="font-medium text-[var(--text)]">{offer.source}</span>
                      {offer.sourceUrl ? (
                        <a
                          href={offer.sourceUrl}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-xs text-[var(--color-primary)] hover:underline truncate max-w-[200px]"
                          title={offer.sourceUrl}
                        >
                          {formatSourceUrl(offer.sourceUrl)} ↗
                        </a>
                      ) : null}
                    </div>
                  </TableCell>
