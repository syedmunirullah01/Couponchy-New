...
export default function StoreSpotlightCard({ store }) {
  ...
  return (
    <Link
      href={store.href ?? "#"}
      className="group relative block overflow-hidden rounded-[32px] border border-white/5 bg-[#0a0a0a] transition-all duration-500 hover:-translate-y-2 hover:border-[var(--color-primary)]/30 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4),0_0_20px_rgba(163,230,53,0.03)]"
    >
      {/* Background Glow */}
      ...
      <div className="relative flex min-h-[380px] flex-col items-center p-8 text-center">
        ...
        <div className="relative mb-8">
          ...
          {store.logoImage ? (
            <div className="relative flex h-24 w-24 items-center justify-center overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.03] transition-transform duration-500 group-hover:scale-110 group-hover:border-[var(--color-primary)]/20">
