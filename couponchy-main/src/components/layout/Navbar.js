      ...
      >
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          <nav className="hidden items-center gap-6 lg:flex" ref={menuRef}>
            {navItems.map((item) => {
              const isActive = item.kind === "mega" ? isDealsActive : pathWithoutCountry === item.href;
                  ...
                  >
                    <button
                      ...
                      className={cn(
                        ...
                        isActive || megaOpen ? "text-white" : "text-white/80 hover:text-white"
                      )}
                      ...
                      <div className="absolute left-0 top-full pt-3">
                        ...
                        <div className="grid grid-cols-[230px_200px_1fr]">
                            ...
                            {displayCategories.map((category) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={cn(
                                    "flex items-center justify-between rounded-[16px] px-3.5 py-2.5 text-left transition",
                                    isCategoryActive
                                      ? "bg-[#24262b] text-white"
                                      : "text-white/92 hover:bg-[#24262b] hover:text-white"
                                  )}
                                >
                                  <span>
                                    <span className="block text-[0.88rem] font-semibold">{category.displayName}</span>
                                    <span className="mt-0.5 block text-[10px] text-white/40">{count} stores</span>
                                  </span>
                          ...
                          <Link
                            ...
                            className={cn(
                              "mt-2 flex items-center justify-between rounded-[14px] border px-3.5 py-2 text-[0.88rem] font-semibold transition",
                              allCategoriesMode
                                ? "border-[var(--accent)]/30 bg-[var(--accent)]/8 text-white"
                          ...
                          <div className={cn("border-r border-white/6 bg-black p-3.5", detailOpen ? "block" : "hidden")}>
                            ...
                            {visibleStores.map((store, index) => (
                              <Link
                                ...
                                onMouseEnter={() => setActiveStoreSlug(store.slug)}
                                  ...
                                  className={cn(
                                    "flex items-center justify-between rounded-[14px] px-3 py-2 transition",
                          ...
                          <Link
                            ...
                            className="mt-1.5 flex items-center justify-between px-3 py-1.5 text-[0.88rem] font-medium text-white/55 transition hover:text-white"
                          >
                          ...
                          <div className={cn("bg-black p-3.5", detailOpen ? "block" : "hidden")}>
                            ...
                            {featuredOffers.length ? (
                              featuredOffers.map(({ offer, store, totalOffers }) => (
                                <Link
                                  ...
                                  className="group flex min-h-[250px] flex-col rounded-[26px] border border-white/8 bg-[#3a3b3f] p-4 transition hover:border-[var(--accent)]/35 hover:bg-[#414247]"
                                >
                                  <div className="flex items-start justify-between gap-3">
                                    <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-[16px] bg-white text-black">
                                      {store?.logoImage ? (
                                        <Image
                                          src={store.logoImage}
                                          alt={store.name}
                                  ...
                                  <div className="mt-3 flex items-center gap-1.5 text-[0.9rem] text-white/58">
                                    <span className="inline-flex h-5 w-5 items-center justify-center rounded-full border border-white/18 text-[9px]">◷</span>
                                    <span>{formatOfferAge(offer.createdAt)}</span>
                                  </div>

                                  <div className="mt-auto pt-4">
                                    <div className="flex items-center rounded-[14px] bg-white/12 px-3 py-3 text-[0.9rem] font-semibold text-white/92">
                              ...
                              featuredStores.map((store) => (
                                <Link
                                  ...
                                  className="group flex min-h-[250px] flex-col rounded-[20px] border border-white/8 bg-[#343638] p-3 transition hover:border-[var(--accent)]/35 hover:bg-[#3a3d40]"
                                >
                                  <div className="flex items-start justify-between gap-2.5">
                                    <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-[12px] bg-white text-black">
                                      {store.logoImage ? (
                                        <Image
                                          src={store.logoImage}
                                          alt={store.name}
                                  ...
                                  <div className="mt-2 flex items-center gap-1.5 text-[11px] text-white/52">
                                    <span className="inline-flex h-4.5 w-4.5 items-center justify-center rounded-full border border-white/12 text-[9px]">C</span>
